...
| [`scripts/pnetlab-upload-and-docker-fix.sh`](file:///e:/Git/EMULATOR/1-P-872-ME-WORKING/scripts/pnetlab-upload-and-docker-fix.sh) | **512MB Upload & Docker Fix**: Boosts upload limits to 512MB and enables kernel IP forwarding. | `sudo bash scripts/pnetlab-upload-and-docker-fix.sh` |
| [`scripts/pnetlab-system-and-console-fix.sh`](file:///e:/Git/EMULATOR/1-P-872-ME-WORKING/scripts/pnetlab-system-and-console-fix.sh) | **SSL & HTML5 Console Fix**: 10-year IP-SAN SSL cert, guacd auto-recovery, and Cloud bridge promiscuous mode. | `sudo bash scripts/pnetlab-system-and-console-fix.sh` |
| [`scripts/pnetlab-database-and-system-deep-fix.sh`](file:///e:/Git/EMULATOR/1-P-872-ME-WORKING/scripts/pnetlab-database-and-system-deep-fix.sh) | **Database & Limits Deep-Fix**: Disables strict SQL mode, scales nofile to 1M, logrotate, and THP tuning. | `sudo bash scripts/pnetlab-database-and-system-deep-fix.sh` |
| [`scripts/pnetlab-image-doctor.sh`](file:///e:/Git/EMULATOR/1-P-872-ME-WORKING/scripts/pnetlab-image-doctor.sh) | **Image Doctor**: Audits image folder naming, template mappings, and QCOW2 disk integrity. | `sudo bash scripts/pnetlab-image-doctor.sh --check` |
| [`connect_pnetlab.bat`](file:///e:/Git/EMULATOR/1-P-872-ME-WORKING/connect_pnetlab.bat) | **Windows Host Connector**: Auto-discovers VM, opens Web UI, and scans node console ports (30001+). | Double-click `connect_pnetlab.bat` |
