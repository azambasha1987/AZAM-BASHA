...
The **PNETLab Speed Optimizer Suite** ([`scripts/pnetlab-speed-optimizer.sh`](file:///e:/Git/EMULATOR/1-P-872-ME-WORKING/scripts/pnetlab-speed-optimizer.sh)) applies four layers of low-overhead system tuning:
